...
public MedicationAdapter(Context context, int textViewResourceId, List<Medication> objects) {
...
holder.lblTitle1Text.setText(stream.getMedicine1Name());
holder.lblTitle2Text.setText(stream.getMedicine2Name());
holder.lblTitle3Text.setText(stream.getInstruction());
