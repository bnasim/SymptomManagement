...
final Patient v = new Patient();
v.setName(nameS);
//v.setCondition(condiS);
CallableTask.invoke(new Callable<Patient>() {

	@Override
	public Patient call() throws Exception {
		
		return readWriteVideoSvcUser1.addPatient(v);
	}
}, new TaskCallback<Patient>() {

	@Override
	public void success(Patient v) {
...
Toast.makeText(getApplicationContext(), "Video " + v.getName()
