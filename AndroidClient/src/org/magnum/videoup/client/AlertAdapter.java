...
Alert stream = getItem(position);
SimpleDateFormat sdf = new SimpleDateFormat("MMM d, yyyy h:mm a");
String dateString = sdf.format(stream.getAlertDate());    
// Populate the item contents
holder.lblTitle1Text.setText(stream.getPname());
holder.lblTitle2Text.setText(dateString);
holder.lblTitle3Text.setText(stream.getMessage());
